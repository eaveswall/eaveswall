...
last-modified: 2020-05-22T21:35:10Z
...
In the Eaveswall editor:
  1. Create an account. Don't worry it's easy. You can sign in with your [Google Gmail Account](https://accounts.google.com)
  2. Create your [author profile][author-profile-admin], where you give your name, an optional image of yourself and a short bio describing who you are.
  3. Write your article's title in the title field of the [editor][admin]
  4. Add an optional thumbnail (an image that tells the story of your article in any way).
  5. Write what you got on mind and publish. Your article would be submitted for review to check that it adheres to our code of conduct.
  6. Bob's your uncle, you just got your article featured!
...
In the Eaveswall editor:
  1. Create an account. Don't worry it's easy. You can sign in with your [Google Gmail Account](https://accounts.google.com)
  2. Create your [author profile][author-profile-admin], where you provide your name, an optional image of yourself and a short bio describing who you are.
  3. Write your article's title in the title field of the [editor][admin]
